...
syncApp.controller('ListViewTemplateCtrl', function ($scope, $rootScope) {
    $scope.datalist = [{ "Name": "Brooke", "Class": "brooke", "Designation": "HR Assistant", "About": "Brooke provides administrative support to the HR office." },
