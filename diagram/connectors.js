...
function updateConnectors(args) {
    var id = args.model.id, constraints;
    switch (id) {
        case "dragable":
            constraints = ej.datavisualization.Diagram.ConnectorConstraints.Drag;
            break;
        case "dragablesource":
            constraints = ej.datavisualization.Diagram.ConnectorConstraints.DragSourceEnd;
            break;
        case "dragabletarget": 
            constraints = ej.datavisualization.Diagram.ConnectorConstraints.DragTargetEnd;
            break;
        case "dragablesegment": 
            constraints = ej.datavisualization.Diagram.ConnectorConstraints.DragSegmentThumb;
            break;
        case "bridge": 
            constraints = ej.datavisualization.Diagram.ConnectorConstraints.Bridging;
            break;
    }
